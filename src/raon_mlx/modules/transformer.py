# Transformer modules for audio codec (Mimi internal transformer).
# Adapted from PersonaPlex/Kyutai Moshi MLX port.
# Original: Copyright (c) Kyutai, all rights reserved.
#
# NOTE: This is the Mimi codec's internal transformer (8 layers, 512 dim).
# The Qwen3 backbone transformer will be in a separate module.
